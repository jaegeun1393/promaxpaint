    ...
    <div className="wrapper sticky top-0 bg-white shadow-lg z-10">
      <div className="contain items-center py-4 xl:py-6 justify-between">
        ...
        >
          ...
          <a href="#" className="text-lightGray" onClick={() => closeMenu('interior-painting')}>
            Interior Painting
          </a>
          <a href="#" className="text-lightGray" onClick={() => closeMenu('exterior-painting')}>
            Exterior Painting
          </a>
          <a href="#" className="text-lightGray" onClick={() => closeMenu('commercial-painting')}>
            Commercial Painting
          </a>
          <NavLink
            to="/gallery"
